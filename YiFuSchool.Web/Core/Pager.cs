...
namespace YiFuSchool.Web.Core
{
    ...
    public class Pager
    {
        ...
        /// <returns></returns>
        public string GetJumperForAjax(int pageIndex, int pageSize, long recordCount, string ajaxProviderFormat, string className = "pagination", string code = "")
        {
            PageIndex = pageIndex;
            PageSize = pageSize;
            RecordCount = recordCount;
        ...
        private void ComputePageNumber()
        {
            ...
            PageCount = Convert.ToInt32(RecordCount / PageSize);
